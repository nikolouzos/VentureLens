...
public struct StartupCosts: Codable {
...
public struct UnitEconomics: Codable {
    public let cac: Int?
    public let ltv: Int?
...
public struct Demographic: Codable {
...
public struct RoadmapPhase: Codable {
